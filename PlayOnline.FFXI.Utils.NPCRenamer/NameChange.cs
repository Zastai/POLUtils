...
namespace PlayOnline.FFXI.Utils.NPCRenamer {
  ...
  internal class NameChange {
    ...
    public string Old  { get { return this.Old_; } }
    public string New  { get { return this.New_; } }

    public string Area {
      get {
        return FFXIResourceManager.GetAreaName((ushort) ((this.ID_ >> 12) & 0xff));
      }
    }
    ...
    public static void LoadHistory() {
      ...
      if (File.Exists(NameChange.HistoryFileName)) {
        ...
        XmlDocument History = new XmlDocument();
          ...
          MessageBox.Show(String.Format(I18N.GetText("Message:HistoryLoadError"), E.Message), I18N.GetText("Title:HistoryLoadError"), MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
      }
    }
