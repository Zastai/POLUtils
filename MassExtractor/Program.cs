...
namespace MassExtractor {
  ...
  internal class Program {
    ...
    private static string TargetApp = AppID.FFXI;
    ...
    static int Main() {
      ...
      bool   ScanAllFiles = false;
        ...
        string[] Args = Environment.GetCommandLineArgs();
          ...
          if (FFXIFolder == null) FFXIFolder = POL.GetApplicationPath(TargetApp, POL.Region.Japan);
          if (FFXIFolder == null) FFXIFolder = POL.GetApplicationPath(TargetApp, POL.Region.NorthAmerica);
          if (FFXIFolder == null) FFXIFolder = POL.GetApplicationPath(TargetApp, POL.Region.Europe);
          if (FFXIFolder == null) {
            Console.ForegroundColor = ConsoleColor.Red;
